    ...
    >
      ...
      {showTooltip && (
        <div
          ...
          className="bg-white/95 backdrop-blur-md text-[#5B4942] text-[10px] py-1.5 px-3 rounded-xl shadow-lg border border-[#E8D8CC] flex items-center gap-2 max-w-[210px] animate-in fade-in slide-in-from-bottom-2 duration-300"
        >
          <span className="w-2 h-2 rounded-full bg-[#25D366] animate-ping shrink-0" />
          <p className="leading-tight text-[10px] font-semibold text-[#5B4942]">
            Online agora • WhatsApp
          </p>
          <button
            type="button"
            onClick={() => setShowTooltip(false)}
            className="p-0.5 rounded-full text-[#7E6961] hover:text-[#5B4942] focus:outline-none shrink-0"
      ...
      <a
        ...
        className="group relative flex items-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white px-3.5 py-2.5 sm:px-4 sm:py-2.5 rounded-full shadow-[0_4px_18px_rgba(37,211,102,0.4)] hover:shadow-[0_6px_22px_rgba(37,211,102,0.55)] hover:scale-105 active:scale-95 transition-all duration-300 border border-white"
      ...
      >
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          fill="currentColor"
          className="shrink-0 relative z-10 drop-shadow-xs"
        >
        ...
        <span className="font-bold text-xs sm:text-sm tracking-wide text-white relative z-10">WhatsApp</span>
      </a>
    </div>
  );
};
